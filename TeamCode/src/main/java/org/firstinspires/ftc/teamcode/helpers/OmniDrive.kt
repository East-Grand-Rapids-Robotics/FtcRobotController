...
class OmniDrive(
    ...
    private fun driveVector(vector: PowerVector) {
        val leftFrontVelocity = vector.leftFrontPower()
        val rightFrontVelocity = vector.rightFrontPower()
        val leftBackVelocity = vector.leftBackPower()
        val rightBackVelocity = vector.rightBackPower()
